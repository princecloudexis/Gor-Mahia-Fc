...
import 'package:kogalo_network/pages/events/location.dart';
import 'package:kogalo_network/pages/events/categoryevents.dart';
import 'package:kogalo_network/pages/events/details.dart';
import 'package:kogalo_network/pages/support/notifications.dart';
import 'package:kogalo_network/pages/profile/profile.dart';
import 'package:kogalo_network/pages/explore/search.dart';
import 'package:kogalo_network/pages/shop/shop.dart';
import 'package:kogalo_network/pages/membership/membership_signup.dart';
...
class _HomeState extends ConsumerState<Home> {
      ...
      body: RefreshIndicator(
        ...
        child: CustomScrollView(
          ...
          slivers: [
            ...
            _buildMembershipExpiryWarning(context),
            ...
            // const SliverToBoxAdapter(child: UpcomingEventsSection()),
            // const SliverToBoxAdapter(child: SizedBox(height: 24)),
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Flexible(
                                child: Text(
                                  membershipAsync.valueOrNull?.membershipType ??
                                      user?.membershipPlan ??
                                      "Free Plan",
                                  style: TextStyle(
  ...
  Widget _buildMembershipExpiryWarning(BuildContext context) {
    final user = ref.watch(userProvider);
    if (user == null || !user.showRenewalWarning) {
      return const SliverToBoxAdapter(child: SizedBox.shrink());
    }

    final difference = user.daysUntilExpiry ?? 0;
        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  'Your membership expires in $difference day${difference == 1 ? '' : 's'}. Renew now to keep your benefits!',
                  style: const TextStyle(
